...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedRefreshToken = (0, jwt_1.verifyToken)(refreshToken, env_1.envVars.JWT_REFRESH_EXPIRES);
    const user = yield user_model_1.User.findOne({ email: verifiedRefreshToken.email });
    const jwtPayload = {
